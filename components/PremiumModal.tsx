        ...
        <div className="bg-white w-full max-w-sm rounded-t-3xl md:rounded-3xl shadow-2xl overflow-hidden relative">
            ...
            <div className="p-6">
                ...
                <button 
                    ...
                    className={`w-full p-4 mb-4 rounded-2xl border-2 flex items-center justify-between transition-all ${
                        canAccess(2, 'MCQ_ANALYSIS') 
                        ? 'border-blue-100 bg-blue-50/50 hover:bg-blue-100 hover:border-blue-300' 
                        : 'border-slate-100 bg-slate-50 opacity-70'
                    }`}
                >
                    <div className="flex items-center gap-3">
                        ...
                        <div className="text-left">
                            <div className="font-bold text-slate-800 text-sm">MCQ Test</div>
                            <div className="text-[10px] text-slate-500">Practice Questions</div>
                        </div>
                    </div>
                    <div className="text-[9px] font-bold bg-white px-2 py-1 rounded border border-blue-200 text-blue-700">
