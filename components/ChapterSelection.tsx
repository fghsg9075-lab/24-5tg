...
import { BookOpen, ChevronRight, Lock, CheckCircle, PlayCircle, Clock, Edit2 } from 'lucide-react';
      ...
      {loading ? (
        ...
        <div className="grid gap-4">
          {chapters.map((chapter, index) => {
            ...
            const isLocked = !isAdmin && (index > userProgress.currentChapterIndex || isExplicitlyLocked);
                ...
                <div className="ml-2 flex gap-2">
                  {isAdmin && (
                      <div 
                          ...
                          className="w-10 h-10 rounded-full bg-slate-100 text-slate-600 flex items-center justify-center hover:bg-blue-100 hover:text-blue-600 z-20 cursor-pointer"
                      >
                          <Edit2 size={18} />
                      </div>
                  )}
